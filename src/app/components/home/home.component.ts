...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  cars: Car[] = [
    ...
    { id: '12', name: 'Sedan Híbrido Branco', imageUrl: 'Sedan Híbrido Branco.webp', price: 68000.25, description: 'Combinação de eficiência energética e conforto para uma condução sustentável.', destaque: true, vendido: false }
  ];
  carsDestaque: Car[] = [];
